...
GO
DBCC CHECKIDENT(N'[dbo].[Categories]', RESEED, 27)
GO
...
GO
GO
INSERT INTO [dbo].[Categories] ([CatID], [CatName]) VALUES (N'25', N'aaaa')
GO
GO
...
GO
DBCC CHECKIDENT(N'[dbo].[NhaSanXuat]', RESEED, 18)
GO
...
GO
GO
INSERT INTO [dbo].[NhaSanXuat] ([IDNhaSanXuat], [TenNhaSanXuat]) VALUES (N'17', N'aa')
GO
GO
INSERT INTO [dbo].[NhaSanXuat] ([IDNhaSanXuat], [TenNhaSanXuat]) VALUES (N'18', N'bb')
GO
GO
...
GO
GO
INSERT INTO [dbo].[Orders] ([OrderID], [OrderDate], [UserID], [Total]) VALUES (N'3', N'2017-05-24 23:11:05.413', N'1021', N'500000000.0000')
GO
GO
INSERT INTO [dbo].[Orders] ([OrderID], [OrderDate], [UserID], [Total]) VALUES (N'4', N'2017-05-25 08:14:12.283', N'1021', N'1500000.0000')
GO
GO
INSERT INTO [dbo].[Orders] ([OrderID], [OrderDate], [UserID], [Total]) VALUES (N'5', N'2017-05-25 20:33:45.613', N'9', N'11900000.0000')
GO
GO
INSERT INTO [dbo].[Orders] ([OrderID], [OrderDate], [UserID], [Total]) VALUES (N'6', N'2017-05-25 20:35:02.520', N'9', N'3000000.0000')
GO
GO
INSERT INTO [dbo].[Orders] ([OrderID], [OrderDate], [UserID], [Total]) VALUES (N'7', N'2017-05-25 20:35:59.350', N'9', N'64000.0000')
GO
GO
INSERT INTO [dbo].[Orders] ([OrderID], [OrderDate], [UserID], [Total]) VALUES (N'8', N'2017-06-02 09:41:05.887', N'1021', N'64000.0000')
GO
GO
...
GO
DBCC CHECKIDENT(N'[dbo].[Products]', RESEED, 73)
GO
...
</UL>', N'1500000.0000', N'4', N'89', N'2017-05-09 00:24:47.000', N'8', N'Việt Nam', N'Cao cấp', N'1', N'0', N'20')
GO
GO
...
</UL>', N'300000.0000', N'6', N'64', N'2017-05-19 00:25:02.000', N'42', N'Việt Nam', N'Trung cấp', N'2', N'0', N'99')
GO
GO
...
', N'1600000000.0000', N'6', N'86', N'2017-05-01 00:25:07.000', N'99', N'Việt Nam', N'Cao cấp', N'2', N'0', N'67')
GO
GO
...
</UL>', N'42000000.0000', N'6', N'63', N'2017-05-30 00:25:12.000', N'107', N'Việt Nam', N'Cao cấp', N'3', N'0', N'42')
GO
GO
...
', N'12900000.0000', N'2', N'0', N'2016-08-20 00:25:17.000', N'14', N'Hàn Quốc', N'Cao cấp', N'4', N'0', N'5')
GO
GO
...
', N'180000.0000', N'4', N'62', N'2017-05-18 00:25:27.000', N'7', N'Việt Nam', N'Thường', N'1', N'0', N'35')
GO
GO
...
', N'29990000.0000', N'2', N'15', N'2017-01-09 00:25:32.000', N'53', N'Hàn Quốc', N'Cao cấp', N'4', N'0', N'89')
GO
GO
...
', N'270000.0000', N'4', N'74', N'2016-11-26 00:25:41.000', N'6', N'Việt Nam', N'Thường', N'1', N'0', N'25')
GO
GO
...
', N'2400000.0000', N'6', N'43', N'2017-02-28 00:25:53.000', N'90', N'Việt Nam', N'Trung cấp', N'2', N'0', N'26')
GO
GO
INSERT INTO [dbo].[Products] ([ProID], [ProName], [TinyDes], [FullDes], [Price], [CatID], [Quantity], [NgayNhap], [SoLuotXem], [XuatXu], [Loai], [IDNhaSanXuat], [BiXoa], [SoLuongDaBan]) VALUES (N'10', N'Đầm chấm bi bé gái', N'Kiểu dáng xinh xắn', N'<UL>
    ...
    <LI>Vải: cotton</LI>
</UL>', N'2800000.0000', N'4', N'80', N'2017-05-19 00:26:06.000', N'79', N'Thái Lan', N'Trung cấp', N'5', N'0', N'19')
GO
GO
...
', N'2500000.0000', N'6', N'88', N'2017-05-27 00:26:11.000', N'200', N'Hoa Kỳ', N'Trung cấp', N'2', N'0', N'5')
GO
GO
...
', N'120000.0000', N'4', N'61', N'2017-03-10 00:26:19.000', N'55', N'Thái Lan', N'Thường', N'1', N'0', N'80')
GO
GO
...
', N'2600000.0000', N'4', N'92', N'2017-05-18 00:26:36.000', N'82', N'Việt Nam', N'Trung cấp', N'5', N'0', N'2')
GO
GO
...
', N'1200000.0000', N'4', N'0', N'2017-04-21 00:26:40.000', N'4', N'Việt Nam', N'Trung cấp', N'5', N'0', N'0')
GO
GO
...
', N'1925000.0000', N'6', N'22', N'2017-05-18 00:26:47.000', N'3', N'Hoa Kỳ', N'Trung cấp', N'2', N'0', N'9')
GO
GO
...
', N'290000.0000', N'2', N'81', N'2017-01-26 00:26:51.000', N'0', N'Hàn Quốc', N'Thường', N'4', N'0', N'6')
GO
GO
...
', N'1820000.0000', N'6', N'33', N'2017-05-12 00:26:58.000', N'3', N'Việt Nam', N'Trung cấp', N'2', N'0', N'8')
GO
GO
...
', N'3400000.0000', N'6', N'10', N'2017-04-26 00:27:02.000', N'7', N'Việt Nam', N'Trung cấp', N'2', N'0', N'10')
GO
GO
...
', N'1820000.0000', N'6', N'17', N'2017-05-09 00:27:06.000', N'9', N'Việt Nam', N'Trung cấp', N'2', N'0', N'10')
GO
GO
...
', N'5400000.0000', N'4', N'0', N'2017-02-16 00:27:15.000', N'7', N'Việt Nam', N'Trung cấp', N'6', N'0', N'9')
GO
GO
...
', N'300000.0000', N'4', N'74', N'2017-05-25 00:27:27.000', N'35', N'Việt Nam', N'Thường', N'6', N'0', N'29')
GO
GO
...
', N'290000.0000', N'4', N'30', N'2017-05-20 00:27:33.000', N'69', N'Việt Nam', N'Thường', N'6', N'0', N'19')
GO
GO
...
', N'36000000.0000', N'6', N'5', N'2017-05-26 00:27:37.000', N'88', N'Việt Nam', N'Cao cấp', N'3', N'0', N'35')
GO
GO
...
', N'14900000.0000', N'6', N'22', N'2017-05-10 00:27:40.000', N'85', N'Hoa Kỳ', N'Cao cấp', N'2', N'0', N'39')
GO
GO
...
', N'2400000000.0000', N'6', N'52', N'2017-05-01 00:27:45.000', N'56', N'Việt Nam', N'Cao cấp', N'2', N'0', N'18')
GO
GO
INSERT INTO [dbo].[Products] ([ProID], [ProName], [TinyDes], [FullDes], [Price], [CatID], [Quantity], [NgayNhap], [SoLuotXem], [XuatXu], [Loai], [IDNhaSanXuat], [BiXoa], [SoLuongDaBan]) VALUES (N'26', N'Nhẫn C900', N'Nữ tính - đầy quí phái', N'<UL>
...
', N'1850000000.0000', N'6', N'11', N'2017-05-16 00:27:48.000', N'88', N'Việt Nam', N'Cao cấp', N'2', N'0', N'20')
GO
GO
...
<P>Cái này rất phù hợp cho bạn khi tặng nàng</P>
', N'3100000000.0000', N'6', N'28', N'2017-05-29 00:27:52.000', N'26', N'Việt Nam', N'Cao cấp', N'2', N'0', N'11')
GO
GO
...
', N'1800000000.0000', N'6', N'29', N'2017-05-25 00:27:58.000', N'18', N'Việt Nam', N'Cao cấp', N'2', N'0', N'10')
GO
GO
...
', N'500000000.0000', N'6', N'49', N'2015-07-23 00:28:05.000', N'19', N'Việt Nam', N'Cao cấp', N'2', N'0', N'9')
GO
GO
...
', N'6990000.0000', N'2', N'0', N'2015-11-15 00:28:14.000', N'5', N'Hàn Quốc', N'Trung cấp', N'4', N'0', N'8')
GO
GO
...
', N'22000.0000', N'1', N'19', N'2010-10-09 00:28:26.000', N'63', N'Việt Nam', N'Thường', N'7', N'0', N'2')
GO
GO
...
</UL>', N'19000.0000', N'1', N'9', N'2017-05-18 00:28:40.000', N'83', N'Việt Nam', N'Thường', N'7', N'0', N'2')
GO
GO
...
</UL>', N'64000.0000', N'1', N'1', N'2017-05-31 00:28:44.000', N'117', N'Việt Nam', N'Thường', N'7', N'0', N'10')
GO
GO
...
</UL>', N'61000.0000', N'1', N'8', N'2017-05-12 00:28:49.000', N'28', N'Việt Nam', N'Thường', N'7', N'0', N'8')
GO
GO
...
</UL>', N'110000.0000', N'1', N'0', N'2017-02-28 00:28:53.000', N'58', N'Việt Nam', N'Thường', N'7', N'0', N'9')
GO
GO
...
</UL>', N'80000.0000', N'1', N'29', N'2017-05-22 00:28:59.000', N'59', N'Việt Nam', N'Thường', N'7', N'0', N'0')
GO
GO
INSERT INTO [dbo].[Products] ([ProID], [ProName], [TinyDes], [FullDes], [Price], [CatID], [Quantity], [NgayNhap], [SoLuotXem], [XuatXu], [Loai], [IDNhaSanXuat], [BiXoa], [SoLuongDaBan]) VALUES (N'52', N'Sách Phong Thủy Cho Văn Phòng', N'Bài trí không gian làm việc để đạt hiệu quả tốt nhất trong công việc', N'<UL> 
    <LI>Công ty phát hành: First News - Trí Việt</LI>
    <LI>Nhà xuất bản: NXB Trẻ</LI>
...
</UL>', N'59000.0000', N'1', N'59', N'2016-02-09 00:29:05.000', N'78', N'Việt Nam', N'Thường', N'7', N'0', N'35')
GO
GO
...
</UL>', N'11900000.0000', N'3', N'9', N'2017-05-10 00:29:20.000', N'56', N'Nhật Bản', N'Cao cấp', N'8', N'0', N'19')
GO
GO
...
</UL>', N'6990000.0000', N'3', N'5', N'2017-05-20 00:29:24.000', N'101', N'Nhật Bản', N'Trung cấp', N'8', N'0', N'29')
GO
GO
INSERT INTO [dbo].[Products] ([ProID], [ProName], [TinyDes], [FullDes], [Price], [CatID], [Quantity], [NgayNhap], [SoLuotXem], [XuatXu], [Loai], [IDNhaSanXuat], [BiXoa], [SoLuongDaBan]) VALUES (N'55', N'Sony DSC-W830', N'Chụp thiếu sáng tốt', N'<UL> 
    ...
    <LI>Bảo hành: 12 tháng</LI>   
    <LI>Xuất xứ: Nhật Bản</LI>  
</UL>', N'2590000.0000', N'3', N'9', N'2017-05-20 00:29:27.000', N'20', N'Nhật Bản', N'Trung cấp', N'9', N'0', N'2')
GO
GO
INSERT INTO [dbo].[Products] ([ProID], [ProName], [TinyDes], [FullDes], [Price], [CatID], [Quantity], [NgayNhap], [SoLuotXem], [XuatXu], [Loai], [IDNhaSanXuat], [BiXoa], [SoLuongDaBan]) VALUES (N'73', N'product', N'tinydes...', N'<p>a</p><p>b</p>', N'500.0000', N'3', N'1', N'2017-06-03 00:00:00.000', N'0', N'vn', N'Cao cấp', N'1', null, null)
GO
GO
...
GO
DBCC CHECKIDENT(N'[dbo].[Users]', RESEED, 1057)
GO
...
GO
GO
INSERT INTO [dbo].[Users] ([f_ID], [f_Username], [f_Password], [f_Name], [f_Email], [f_DOB], [f_Permission]) VALUES (N'1021', N'a', N'B59C67BF196A4758191E42F76670CEBA', N'a', N'a@g.com', N'2017-01-29 00:05:00.000', N'0')
GO
GO
INSERT INTO [dbo].[Users] ([f_ID], [f_Username], [f_Password], [f_Name], [f_Email], [f_DOB], [f_Permission]) VALUES (N'1056', N'c', N'B59C67BF196A4758191E42F76670CEBA', N'c', N'c@g.c', N'1999-01-29 00:06:00.000', N'0')
GO
GO
INSERT INTO [dbo].[Users] ([f_ID], [f_Username], [f_Password], [f_Name], [f_Email], [f_DOB], [f_Permission]) VALUES (N'1057', N'p', N'B59C67BF196A4758191E42F76670CEBA', N'user 0009', N'a@g.com', N'1999-01-12 00:06:00.000', N'1')
GO
GO
