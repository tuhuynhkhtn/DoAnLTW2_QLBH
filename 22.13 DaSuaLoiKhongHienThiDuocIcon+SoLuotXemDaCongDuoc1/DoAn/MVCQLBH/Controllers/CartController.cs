...
namespace MVCQLBH.Controllers
{
    public class CartController : Controller
    {
        ...
        //Them san pham tu danh sach cung loai
        [HttpPost]
        //public ActionResult AddProIFromListDetail(int proId, int proIdAddCart)
        public ActionResult AddProIFromListDetail(int proId)
        {
            if (Session["cart"] == null)
            {
                Session["cart"] = new Cart();
