...
namespace MVCQLBH.Controllers
{
    ...
    public class ManageProductController : Controller
    {
        ...
        public ActionResult AjaxAddPro(ProInfo proInfo, HttpPostedFileBase imgLg, HttpPostedFileBase imgSm)
        {
            ...
            if(imgSm == null)
            {
                ErrP.ErrorImgSmInfo = "Chọn hình nhỏ";
            }

            if(ErrP.ErrorProNameInfo != null || ErrP.ErrorNgayNhapInfo != null || ErrP.ErrorTinyDesInfo != null || ErrP.ErrorImgLgInfo!= null || ErrP.ErrorImgSmInfo != null || ErrP.ErrorFullDesInfo != null)
            {
                return Json(ErrP);
            }
        ...
        public ActionResult UpdatePro(int pIdUpdate)
        {
            using (var dc = new QLBHEntities())
            {
                var pro = dc.Products.Where(p => p.ProID == pIdUpdate).FirstOrDefault();
                return View(pro);
            }
        }
