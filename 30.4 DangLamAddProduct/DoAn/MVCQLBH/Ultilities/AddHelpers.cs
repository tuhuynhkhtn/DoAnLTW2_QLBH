...
namespace MVCQLBH.Ultilities
{
    public static class AddHelpers
    {
        ...
        public static IList<SelectListItem> GetSLIXuatXu(this HtmlHelper html)
        {
            var l = new List<SelectListItem>();
            l.Add(new SelectListItem { Value = "Hàn Quốc", Text = "Hàn Quốc" });
            l.Add(new SelectListItem { Value = "Trung Quốc", Text = "Trung Quốc" });
            l.Add(new SelectListItem { Value = "Việt Nam", Text = "Việt Nam" });
            return l;
        }
        ...
        private static string rgExp = "^[^<>{}\"/|;:,~!?@#$%^=&*\\]\\\\()\\[¿§«»ω⊙¤°℃℉€¥£¢¡®©0-9_+]*$";
        ...
        public static ProInfoError GetErrorProduct(ProInfo pro)
        {
            ...
            {
                if(CheckNamePro(pro.ProNameInfo) == true)
                {
            ...
            {
                Err.ErrorTinyDesInfo = "Nhập tóm tắt sản phẩm";
            }
